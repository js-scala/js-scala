...
programming concerns: \code{null} references handling and type safety.
...
length of some parts of code (DOM definition and \code{null} reference handling). The size of code parts dealing with
