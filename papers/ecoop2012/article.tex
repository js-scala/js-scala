...
It's important to note that reification preserves function composition (roughly speaking it's homomorphism between DSL code and generated JavaScript code).
